...
/*   Updated: 2024/10/24 18:55:21 by andrefranci      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool testAddEdges()
{
    ...
    try
    {
        ...
        if (edges.size() != 2)
        {
            std::cerr << RED << "Error: Expected 2 edges, found " << edges.size() << RESET << std::endl;
            testPassed = false;
        }
        ...
        if (!foundEdgeB)
        {
            std::cerr << RED << "Error: Edge to node B with distance 10 not found" << RESET << std::endl;
            testPassed = false;
        }
        if (!foundEdgeC)
        {
            std::cerr << RED << "Error: Edge to node C with distance 20 not found" << RESET << std::endl;
            testPassed = false;
        }
    ...
    {
        std::cerr << RED << "Exception in testAddEdges: " << e.what() << RESET << std::endl;
        testPassed = false;
    }
...
bool testDuplicateEdge()
{
    ...
    try
    {
        ...
        {
            nodeA->addEdge(nodeB, 10);
            std::cerr << RED << "Error: Expected EdgeAlreadyExistsException not thrown" << RESET << std::endl;
            testPassed = false;
        }
        catch (const Node::EdgeAlreadyExistsException &e)
        {
            std::cerr << GREEN << "Caught expected exception: " << e.what() << RESET << std::endl;
        }

        std::cout << GREEN << "testDuplicateEdge completed." << RESET << std::endl;
    }
    catch (const std::exception &e)
    {
        std::cerr << RED << "Exception in testDuplicateEdge: " << e.what() << RESET << std::endl;
        testPassed = false;
    }
...
bool testSelfEdge()
{
    ...
    try
    {
        ...
        try
        {
            ...
            std::cerr << RED << "Error: Expected SelfEdgeException not thrown" << RESET << std::endl;
            testPassed = false;
        }
    ...
    {
        std::cerr << RED << "Exception in testSelfEdge: " << e.what() << RESET << std::endl;
        testPassed = false;
    }
...
bool testDuplicateNode()
{
    ...
    try
    {
        ...
        try
        {
            ...
            std::cerr << RED << "Error: Expected DuplicateNodeException not thrown" << RESET << std::endl;
            testPassed = false;
        }
        ...
        std::cout << GREEN << "testDuplicateNode completed." << RESET << std::endl;
    }
    catch (const std::exception &e)
    {
        std::cerr << RED << "Exception in testDuplicateNode: " << e.what() << RESET << std::endl;
        testPassed = false;
    }
...
{
    std::cout << CYAN << "Node " << node->getName() << " has edges to:" << RESET << std::endl;
