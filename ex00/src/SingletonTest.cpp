...
/*   Updated: 2024/09/16 17:40:59 by abaiao-r         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
    MyClass()
    {
        std::cout << GREEN << "MyClass Constructor Called!" << RESET << std::endl;
    }
...
void testBasicFunctionality()
{
    ...
    instance.display();
    std::cout << GREEN << "Basic Functionality Test Passed!" << RESET << std::endl;
}
...
void testUniqueness()
{
    ...
    try
    {
        ...
        std::cout << GREEN << "Uniqueness Test Passed: Both instances are the same!" << RESET << std::endl;
    } 
    catch (...)
    {
        std::cout << RED << "Uniqueness Test Failed: Instances are different!" << RESET << std::endl;
    }
}
...
void testThreadSafety()
{
    ...
    for (int i = 0; i < numThreads; ++i)
    {
        ...
        {
            instances[i] = &Singleton<MyClass>::getInstance();
        });
    }
    ...
    try {
        ...
        std::cout << GREEN << "Thread Safety Test Passed: All instances are the same!" << RESET << std::endl;
    }
    catch (...)
    {
        std::cout << RED << "Thread Safety Test Failed: Instances are different!" << RESET << std::endl;
    }
}
...
void testCopyAndMoveConstructor()
{
    ...
    std::cout << YELLOW << "To test Copy and Move Constructor, uncomment the lines in the test function!\n If compilation errors occur, the test is successful!" << RESET << std::endl;
}
...
void testAssignmentOperator()
{
    ...
    std::cout << YELLOW << "To test Assignment Operator, uncomment the lines in the test function!\n If compilation errors occur, the test is successful!" << RESET << std::endl;
}
